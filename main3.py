...
tp1=Radiobutton(frame1,text="Elipsóidal 2:1",variable=tampo,value=1,command=lambda: hide_angcone(ang_cone,ang_cone1))

tp2=Radiobutton(frame1,text="Toro Esférico",variable=tampo,value=2,command=lambda: hide_angcone(ang_cone,ang_cone1))

tp3=Radiobutton(frame1,text="Hemisférico",variable=tampo,value=3,command=lambda: hide_angcone(ang_cone,ang_cone1))

tp4=Radiobutton(frame1,text="Cônico",variable=tampo,value=4,command=lambda: show_angcone(ang_cone,ang_cone1))
