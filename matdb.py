...
def mat_db_wdw():
    mat_db = GUI(window_type.mat_db)

    mat_frame = mat_db.create_LabelFrame( "Lista de Materiais", rowint=1, columnint=2, padxint=10, padyint=10, rowspanint=15)
    ...
    mat_db.create_Label( "Tensão Admissível do Material(MPa):", 2, 0, stickystr='W')
